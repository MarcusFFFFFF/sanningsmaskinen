# -*- coding: utf-8 -*-
"""
SANNINGSMASKINEN v8.31 — STREAMLIT UI
Ändring från v8.17b:
...
<div class="topbar">
  ...
  <div class="topbar-right">v8.31 · Claude Opus + GPT-4o · {today_str}</div>
</div>
...
""", unsafe_allow_html=True)
    ...
    st.markdown(f"""
<div class="footer">
  Sanningsmaskinen v8.31 - {_date.today()} - {rc_pill_lbl} - {st_pill_lbl}
